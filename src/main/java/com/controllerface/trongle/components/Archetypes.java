...
public class Archetypes
{
                               ...
                               Vector3d scale)
    {
        ...
        ecs.set_component(entity, Component.Acceleration, new Vector3d(0.0));
        ecs.set_component(entity, Component.AngularAcceleration, new MutableFloat(0.0f));
        ecs.set_component(entity, Component.Velocity, new Vector3d(0.0));
        ecs.set_component(entity, Component.AngularVelocity, new MutableFloat(0.0f));
        ...
        ecs.set_component(entity, Component.Thrust, new MutableFloat(0.0f));
        ecs.set_component(entity, Component.Yaw, new MutableFloat(0.0f));
